...
import argparse, base64, getpass, glob, math, os, pathlib, PIL.ImageDraw, PIL.ImageOps, platform, qrcode, subprocess, sys, tempfile
...
PIL.ImageDraw.Draw(img).text((0,0), args.name_of_file, font_size = 34)
